...
class TodoListInterface {
  ...
  virtual int remove(string _task) = 0;    /*    *   Prints out the full todo list to the console    */    
  virtual void printTodoList() = 0;    /*    *   Prints out all items of a todo list with a particular due date (specified by _duedate)    */    
